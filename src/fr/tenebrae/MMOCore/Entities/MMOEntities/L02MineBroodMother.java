...
import fr.tenebrae.MMOCore.Entities.MMOSpider;
import fr.tenebrae.MMOCore.Items.ItemRegistry;
import fr.tenebrae.MMOCore.Items.Coins.CopperCoin;

public class L02MineBroodMother extends MMOSpider {
	
	public L02MineBroodMother(Location loc) {
		...
		this.drops.put(new CopperCoin(new Random().nextInt(8)+7), 80.0);
