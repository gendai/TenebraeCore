...
public class L17NivlasSpider extends MMOCaveSpider {

	public L17NivlasSpider(Location loc) {
		...
		this.drops.put(new CopperCoin(new Random().nextInt(36)+63), 80.0);
		this.drops.put(new SilverCoin(new Random().nextInt(2)+1), 62.2);
